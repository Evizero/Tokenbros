...
function head(c:CanvasRenderingContext2D,y=0,gaze=0){
 ...
 rect(c,-6,y+4,6,5,'#31303b');rect(c,2,y+4,6,5,'#31303b');rect(c,0,y+5,2,1,'#c6bacd');rect(c,-5,y+5,4,3,'#b7d6d4');rect(c,3,y+5,4,3,'#c6dfde');rect(c,9,y+9,3,2,'#454054');rect(c,-2,y+6+gaze,1,1,'#343240');rect(c,6,y+6+gaze,1,1,'#343240');
}
