...
export function showRoster(g:Game){
 ...
 g.vertical.clear();g.marcusKit.clear();g.pidalfKit.clear();g.defense.release();g.dimillianKit.clear();g.audio.silenceRobots();g.state='title';g.keys.clear();g.pointer.down=false;g.pendingShot=0;
