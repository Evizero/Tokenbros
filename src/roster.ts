...
export function showRoster(g:Game){
 ...
 <div class="roster-deploy"><span class="controller-menu-hint" hidden>LS / D-PAD SELECT · A CONFIRM · MENU DEPLOY · Y OPTIONS</span><button class="primary" id="start">DEPLOY <span class="arrow">↗</span></button></div>`;
