...
const roster:{id:Bro;name:string;role:string;color:string;style:string;description:string;kit:string[]}[]=[
 ...
 {id:'dimillian',name:'DIMILLIAN',role:'THE HOT RELOADER',color:'#c39aff',style:'SHAPESHIFTER',description:'Baguette duelist. Lightning mage. Miniature starfighter.',kit:['Pair / sheep / bomb','Form shield','Form ultimate']},
 ...
 {id:'marcus',name:'MARCUS',role:'THE AUGMENTOR',color:'#70e1ef',style:'ARCADE TRICKSHOTS',description:'Launch. Reposition. Recall. Load an arcade. Chain your bites.',kit:['Recall','Flip dodge','Batch mode']},
 {id:'theo',name:'THEO',role:'THE FREE RIDER',color:'#78d9ff',style:'SKATE / BRAWL',description:'Run onto your board. Brawl, ram, throw and catch it without breaking stride.',kit:['Throw / recall','Shield toss','']},
];
...
export function showRoster(g:Game){
 ...
 overlay.innerHTML=`<div class="roster-heading"><div><div class="roster-kicker">OPERATION HARD RESET</div><h1>TOKEN<span>BROS</span></h1></div><div class="roster-prompt"><h2>CHOOSE YOUR BRO</h2><span>06 READY / ALL SYSTEMS GO</span></div></div>
